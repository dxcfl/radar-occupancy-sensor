...
#define GENERATED_ATTRIBUTES                                                                                                       \
    {                                                                                                                              \
        ...
        { ZAP_EMPTY_DEFAULT(), 0x00000000, 0, ZAP_TYPE(ARRAY), ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) },      /* DeviceTypeList */   \
            ...
            { ZAP_SIMPLE_DEFAULT(0x0), 0x00000001, 1, ZAP_TYPE(ENUM8), 0 },   /* OccupancySensorType */                            \
            { ZAP_SIMPLE_DEFAULT(0x1), 0x00000002, 1, ZAP_TYPE(BITMAP8), 0 }, /* OccupancySensorTypeBitmap */                      \
            { ZAP_SIMPLE_DEFAULT(30), 0x00000010, 2, ZAP_TYPE(INT16U),                                                             \
...
#define GENERATED_ENDPOINT_TYPES                                                                                                   \
    {                                                                                                                              \
        { ZAP_CLUSTER_INDEX(0), 11, 98 }, { ZAP_CLUSTER_INDEX(11), 4, 33 }, { ZAP_CLUSTER_INDEX(15), 3, 22 },                      \
    }
